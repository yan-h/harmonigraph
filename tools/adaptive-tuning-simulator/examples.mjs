...
export const EXAMPLES = [
  ...
  { id: 'pedal', name: 'An old pedal releases last', category: 'Memory',
    description: 'C was attacked first but released last. Inspect its new position at the front of released memory.',
    program: 'on C3 c\non E3 e\non G3 g\noff e\noff g\noff c',
    check: sim => sim.recent[0]?.id === 'c', expected: 'C is the newest released contribution.' },
