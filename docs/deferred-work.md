...
|---|---|---|
| [SG3 / #657: whole-song temporal coverage](https://github.com/yan-h/harmonigraph/issues/657) | Retired with Playhead under #973; its evidence describes the removed path. | No implementation planned. |
