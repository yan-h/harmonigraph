...
pub(crate) type SpectrumBuckets = [f32; lattice_core::spectrum::SPECTRUM_BINS];
...
pub struct AudioSpectrum {
    ...
    pub(crate) analyzer: lattice_core::spectrum::ChannelBank,
...
pub(crate) struct SpectrogramSurface {
    ...
    pub(crate) agg: Option<crate::panes::spectrogram::SpectrogramAgg>,
    ...
    pub(crate) ring: Option<crate::panes::spectrogram::SpectrogramRing>,
    ...
    pub(crate) restarts: [u32; crate::panes::spectrogram::Restart::COUNT],
}
...
pub(crate) struct SpectrogramKey {
    ...
    pub(crate) style: crate::panes::spectrogram::ColumnStyle,
...
pub(crate) struct SpectrogramCache {
    ...
    pub(crate) layout: crate::panes::spectrogram::TexLayout,
}
