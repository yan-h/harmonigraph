...
pub use atmosphere::{
    ...
    BREATH_SPEED_MAX, BREATH_SPEED_MIN, CLOUD_SIZE_MAX, CLOUD_SIZE_MIN, CLOUD_SPEED_MAX,
    CLOUD_SPEED_MIN, CONTOURS_MAX, CONTOURS_MIN, CONTOUR_SOFTNESS_MAX, CONTOUR_SOFTNESS_MIN,
    NEBULA_SCALE_MAX, NEBULA_SCALE_MIN, NEBULA_SPEED_MAX, NEBULA_SPEED_MIN, PITCH_SOFTNESS_MAX,
