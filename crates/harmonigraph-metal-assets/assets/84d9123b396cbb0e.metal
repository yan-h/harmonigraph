...
, constant _mslBufferSizes& _buffer_sizes [[buffer(2)]]
    ...
    return vs_mainOutput { _tmp.clip_pos, _tmp.uv, _tmp.params, _tmp.octaves, _tmp.thickness, _tmp.motion, _tmp.cents, _tmp.strip_row, _tmp.marks, _tmp.melody_color, _tmp.bass_color, _tmp.rim, _tmp.swell, _tmp.ring, _tmp.ink_carry, _tmp.shadow_box, _tmp.shadow_at };
}
