    ...
    while(true) {
        ...
        }
        {
            ...
            if (band_out_1 > band_in_1) {
                ...
                NodeLayer _e127 = outer_glyph(slot_4, oct_2, uv_6, _e126, band_in_1, band_out_1, soft, u);
                metal::float4 _e128 = oct_slot_ink(in_8, slot_4, u);
                float taper = 1.0 - metal::smoothstep(1.0, GLYPH_FADE_LIMIT, d_6);
                float coverage_2 = ((_e127.coverage * taper) * _e128.w) * opacity_2;
                float _e140 = result.alpha;
                if (coverage_2 > _e140) {
                    result.rgb = _e128.xyz * coverage_2;
            ...
            if (_e185) {
                ...
                NodeLayer _e215 = glyph_band(d_6, mark_in_1, mark_out_1, level_4, soft);
                NodeLayer _e216 = outer_glyph(slot_4, oct_2, uv_6, _e215, mark_in_1, mark_out_1, soft, u);
                float taper_1 = 1.0 - metal::smoothstep(1.5600001, QUAD_MARGIN, d_6);
                float _e222 = layer_coverage(_e216);
                float coverage_3 = _e222 * taper_1;
                ...
                float _e237 = mask_level(level_4);
                marks.mask = metal::max(_e234, (_e216.coverage * taper_1) * _e237);
                float _e242 = marks.sd;
                float _e247 = layer_distance(_e242, NodeLayer {_e216.sd * scale, level_4, _e216.coverage}, in_8);
                marks.sd = _e247;
            }
        }
    }
