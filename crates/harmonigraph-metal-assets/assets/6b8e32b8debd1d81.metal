...
metal::float4 backdrop_color(
    ...
    if (_e3) {
        float _e4 = baked_density(position_4, close_light, cloud_sampler, cloud);
        level_3 = _e4;
    }
    float _e5 = level_3;
    metal::float4 _e6 = clouded(_e5, position_4, lut, close_light, wide_light, cloud_sampler, cloud);
    return _e6;
}
