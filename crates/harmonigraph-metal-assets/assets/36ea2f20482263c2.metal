...
Glob wash_glob(
    ...
    out_3.edge = (metal::length(r_2 - centre_1) / radius_1) + wob;
    Glob _e41 = out_3;
    return _e41;
}
        ...
        }
        {
            ...
            while(true) {
                ...
                }
                {
                    ...
                    float _e51 = out_4.cover;
                    out_4.cover = metal::max(_e51, metal::clamp(prox / 0.05, 0.0, 1.0));
                    if (_e45.edge < 1.0) {
                        float _e62 = best;
                        if (_e45.order > _e62) {
                            float _e64 = best;
                            second = _e64;
                            metal::float2 _e67 = out_4.centre;
                            out_4.under = _e67;
                            best = _e45.order;
                            out_4.centre = _e45.centre;
                            out_4.edge = _e45.edge;
                        } else {
                            float _e74 = second;
                            if (_e45.order > _e74) {
                                second = _e45.order;
                                out_4.under = _e45.centre;
                            }
                        }
                    } else {
                        float _e79 = near_a;
...
WashField wash_field(
    ...
    if (want_fine) {
        ...
        out_5.fine = _e98;
        out_5.cover = _e96.cover;
    }
    WashField _e101 = out_5;
    return _e101;
}
