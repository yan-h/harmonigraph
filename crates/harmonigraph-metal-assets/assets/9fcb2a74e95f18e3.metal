...
float wash_noise(
    ...
    metal::float3 _e12 = wash_hash(i_2, salt_1);
    float n00_ = _e12.x;
    metal::float3 _e18 = wash_hash(as_type<metal::int2>(as_type<metal::uint2>(i_2) + as_type<metal::uint2>(metal::int2(1, 0))), salt_1);
    float n10_ = _e18.x;
    metal::float3 _e24 = wash_hash(as_type<metal::int2>(as_type<metal::uint2>(i_2) + as_type<metal::uint2>(metal::int2(0, 1))), salt_1);
    float n01_ = _e24.x;
    metal::float3 _e30 = wash_hash(as_type<metal::int2>(as_type<metal::uint2>(i_2) + as_type<metal::uint2>(metal::int2(1, 1))), salt_1);
    float n11_ = _e30.x;
...
, constant Cloud& cloud [[buffer(2)]]
    ...
    float _e8 = cloud_tone_at(metal::float2(in.slab, in.t) * _e6, close_light, wide_light, cloud_sampler, cloud);
