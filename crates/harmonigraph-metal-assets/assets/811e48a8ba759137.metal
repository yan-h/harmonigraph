...
, constant _mslBufferSizes& _buffer_sizes [[buffer(1)]]
    ...
    metal::float4 core = {};
    metal::float4 outline = {};
    if (i_id < (_buffer_sizes.buffer_size15 / 80)) {
    ...
    return vs_shadow_cellOutput { _tmp.position, _tmp.local, _tmp.half_extent, _tmp.shear, _tmp.outline_reach, _tmp.lead, _tmp.lead_fade, _tmp.lead_alpha, _tmp.cap_reach, _tmp.core, _tmp.outline, _tmp.at, _tmp.who, _tmp.feather, _tmp.ramp, _tmp.reads };
}
