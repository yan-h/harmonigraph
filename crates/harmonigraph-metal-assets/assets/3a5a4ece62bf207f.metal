...
struct fs_blitOutput {
    metal::float4 member [[color(0)]];
};
fragment fs_blitOutput fs_blit(
  fs_blitInput varyings [[stage_in]]
...
, metal::sampler scene_samp [[sampler(0)]]
    ...
    metal::float4 _e4 = scene_tex.sample(scene_samp, in.uv);
    return fs_blitOutput { _e4 };
}
