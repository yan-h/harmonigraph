...
struct fs_glyph_distanceOutput {
    metal::float4 member [[color(0)]];
};
fragment fs_glyph_distanceOutput fs_glyph_distance(
  fs_glyph_distanceInput varyings [[stage_in]]
...
, metal::texture2d<float, metal::access::sample> sdf_atlas [[texture(2)]]
    ...
    return fs_glyph_distanceOutput { metal::float4(_e1, 0.0, 0.0, 1.0) };
}
