...
WashField wash_tile_field(
    ...
    if (_e19 > 0.0) {
        ...
        metal::float2 _e28 = rotate_watercolor_tile_vector(b_5.xy, cloud);
        out_5.fine = Wet {_e28};
        out_5.cover = b_5.w;
    }
...
float wash_cloud_tone(
    ...
    if (_e52 > 0.0) {
        ...
        float _e66 = level_3;
        level_3 = metal::mix(_e66, _e59, over);
    }
    float _e68 = level_3;
    return _e68;
}
...
metal::float4 clouded(
    ...
    metal::float4 _e38 = density_color(metal::mix(level_4, _e33, _e36), lut, cloud);
    return _e38;
}
