...
NodeGeom node_geom(
    ...
    if (ring_draws) {
        local_16 = metal::length(src.uv) >= (_e27.x - _e9);
    } else {
        local_16 = false;
    }
    bool _e39 = local_16;
    if (_e39) {
        local_17 = metal::length(src.uv) <= (_e27.y + _e9);
    } else {
        local_17 = false;
    }
    ...
    bool _e59 = local_19;
    if (_e59) {
        local_20 = src.params.x <= 0.0;
    } else {
        local_20 = false;
    }
    bool _e67 = local_20;
    if (_e67) {
        local_21 = src.params.y <= 0.0;
    } else {
        local_21 = false;
    }
    bool _e75 = local_21;
    if (_e75) {
        local_22 = src.params.z <= 0.0;
    } else {
        local_22 = false;
    }
    bool _e83 = local_22;
    if (_e83) {
        local_23 = ((src.octaves.x | src.octaves.y) | src.octaves.z) == 0u;
    } else {
        local_23 = false;
    }
    bool _e97 = local_23;
...
AnimatedInk animated_slice_ink(
    ...
    while(true) {
        ...
        }
        {
            ...
            metal::float2 uv_7 = anchor + ((in_7.uv - start) / metal::float2(scale));
            ...
            if (band_out_1 > band_in_1) {
                ...
                float coverage_2 = ((_e119.coverage * taper) * _e120.w) * opacity_2;
                float _e132 = result.alpha;
                if (coverage_2 > _e132) {
                    result.rgb = _e120.xyz * coverage_2;
                    result.alpha = coverage_2;
            ...
            if (_e177) {
                ...
                float coverage_3 = _e214 * taper_1;
                ...
                float _e239 = layer_distance(_e234, NodeLayer {_e208.sd * scale, level_7, _e208.coverage});
                marks.sd = _e239;
            }
        }
    }
...
Painted node_paint(
    ...
    NodeGeom _e2 = node_geom(in_8, false, u);
    ShadowThrough _e9 = node_shadow_through(in_8.shadow_box.x, in_8.shadow_at.xy, in_8.shadow_at.z, shadow_atlas, shadow_sampler, shadow_casters, u, _buffer_sizes);
    if (!(_e2.paints)) {
    ...
    NodeInk _e28 = node_ink(in_8, _e2.d, _e2.aa, _e2.oct, false, u);
    ink_2 = _e28;
    ...
    bool _e48 = shadow_is_distance(in_8.shadow_box.x, shadow_casters, _buffer_sizes);
    ...
    if (_e66 > 0.0) {
        ...
        float _e77 = node_visibility(in_8.shadow_box.x, in_8.shadow_at.xy, _e76, shadow_atlas, shadow_sampler, shadow_casters, _buffer_sizes);
        visibility_1 = _e77;
    }
    ...
    metal::float2 _e96 = light_coord(in_8.clip_pos.xy, u);
