...
NodeInk base_node_ink(
    ...
    while(true) {
        ...
        }
        {
            ...
            float _e96 = oct_slot_level(in_10.octaves, slot_3);
            if (_e96 <= 0.0) {
            ...
            NodeLayer _e107 = outer_glyph(slot_3, oct_1, in_10.uv, _e106, band_in_1, band_out_1, aa_7, u);
            float _e108 = layer_coverage(_e107);
            metal::float4 _e109 = oct_slot_ink(in_10, slot_3, u);
            float opacity_1 = _e109.w;
            slot_rgb = _e109.xyz;
            cov_1 = _e108 * opacity_1;
            lit_shape = _e108;
            float _e116 = slice_reach(in_10, slot_3, band_in_1, band_out_1, u);
            if (_e116 == band_out_1) {
                ...
                SliceZones _e127 = slice_zones(in_10, slot_3, oct_1, in_10.uv, d_5, _e107, _e109, band_in_1, band_out_1, _e116, aa_7, u);
    ...
    while(true) {
        ...
        }
        {
            ...
            if (band_out_2 > band_in_2) {
                ...
                metal::float4 _e97 = oct_slot_ink(in_12, slot_4, u);
                float _e98 = glyph_taper(d_9, swells_2);
                float _e100 = oct_slot_level(in_12.octaves, slot_4);
                coverage_1 = ((_e96.coverage * _e98) * _e97.w) * _e56;
                rgb = _e97.xyz;
                lit = _e100 / metal::max(_e97.w, 0.0001);
                float _e114 = slice_reach(in_12, slot_4, band_in_2, band_out_2, u);
                if (_e114 == band_out_2) {
                    ...
                    SliceZones _e136 = slice_zones(in_12, slot_4, oct_2, uv_7, d_9, _e96, _e97, band_in_2, band_out_2, _e114, soft, u);
                    rgb = _e136.ink.xyz;
            ...
            metal::float2 _e200 = mark_radii(in_12, slot_4, mark_in_1, mark_out_1, u);
            if (slot_4 >= 0) {
                local_31 = slot_4 < 11;
            } else {
                local_31 = false;
            ...
            if (_e215) {
                ...
                float _e281 = layer_distance(_e276, NodeLayer {_e250.sd * scale, level_4, _e250.coverage}, in_12);
                marks.sd = _e281;
            }
        }
    }
