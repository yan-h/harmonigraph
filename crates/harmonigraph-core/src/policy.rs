...
impl Memory {
    ...
    pub fn attack(&mut self, pitch: i64, correction: i64, config: PolicyConfig) {
        self.remove_match(pitch, config.tolerance);
...
pub fn assign_new_note(
    ...
    select_prepared(config, reference, onset, scratch)
}
