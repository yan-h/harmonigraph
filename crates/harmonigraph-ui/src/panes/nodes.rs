...
fn audio_section(ui: &mut egui::Ui, view: &mut ViewConfig) {
    section(ui, "Audio ring", |ui| {
        ...
        // node's.
        let zoomed =
            view.spectral_ring_draws() && view.spectral_reading == SpectralReading::Spectrum;
