...
impl WindowState {
    ...
    unsafe fn setup_timer(window_state_ptr: *const WindowState) {
        ...
        // Use common modes rather than the default mode: timers in the default
        // mode do not fire while the run loop is in an event-tracking mode
        // (e.g. during native window resizing or other mouse-tracking loops),
        // which freezes the GUI for the duration of the drag.
